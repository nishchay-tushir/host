    ...
    return (
        <>
            ...
            <div className='bg-gray-900 w-fit m-3 rounded-xl p-2 shadow-lg shadow-gray-700 text-white overflow-hidden fixed'>
                ...
                <h1 onClick={Breakdown} className={`p-2 cursor-pointer shadow-md rounded-lg my-1 ${isBreakdownClicked ? 'bg-green-700 ' : 'hover:bg-green-700 '}`}>Breakdown Report</h1>
                <h1 onClick={L4Contorls} className='p-2 cursor-pointer shadow-md rounded-lg my-1 hover:bg-green-700'>L4 Controls</h1><br />
