...
const InhouseLight14q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/inhouse_lights_14_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/inhouse_lights_14_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Inhouse Light-14</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : In-house Tube light-Electronic-Production area-wash room- L</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FN/UTM/ELECET/WR-L/TL/4167 TO 4174)</h1>
      <hr /><hr /><br /><br />
...
export default InhouseLight14q;