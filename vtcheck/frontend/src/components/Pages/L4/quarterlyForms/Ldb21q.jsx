...
const Ldb21q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/ldb_21_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/ldb_21_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : LDB Panel 1- canteen </h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/CANTEEN/LDBP1/6107)</h1>
      <hr /><hr /><br /><br />
