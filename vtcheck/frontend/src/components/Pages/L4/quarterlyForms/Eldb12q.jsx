...
const Eldb12q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/eldb_12_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/eldb_12_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : ELDB Panel- Admin office (Near confrence room)</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/ELDBP/6064)</h1>
      <hr /><hr /><br /><br />
