...
const WaterChiller4q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/water_chiller_4_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/water_chiller_4_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Water cooler -4</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Water cooler -4 </h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/WCOOLER4/6248)</h1>
