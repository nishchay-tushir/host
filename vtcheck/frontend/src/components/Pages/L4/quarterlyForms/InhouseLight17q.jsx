...
const InhouseLight17q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/inhouse_lights_17_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/inhouse_lights_17_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Inhouse Light-17</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : In-house ceiling light-Mechanical Office</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/MECHA/OFF/CAB1/CL/4307 TO 4351)</h1>
      <hr /><hr /><br /><br />
...
export default InhouseLight17q;