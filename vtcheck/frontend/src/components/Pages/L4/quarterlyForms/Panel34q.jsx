...
const Panel34q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/panel_34_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/panel_34_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Panel-Electroninc prodcution area-3 </h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/ELECT/PRODA/PNL3/5259)</h1>
      <hr /><hr /><br /><br />
