...
const InhouseLight77q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/inhouse_lights_77_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/inhouse_lights_77_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Inhouse Light-77</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : In-house tube light-Material gate-Security cabin 1 & 2</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/TRANSY1/LEDL/5945 TO 5954)</h1>
      <hr /><hr /><br /><br />
...
export default InhouseLight77q;