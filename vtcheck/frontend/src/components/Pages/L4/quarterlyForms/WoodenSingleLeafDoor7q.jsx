...
const WoodenSingleLeafDoor7q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/wooden_single_leaf_door_7_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/wooden_single_leaf_door_7_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Door-STP-Wooden single leaf door</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/STP/WSLD/5388)</h1>
      <hr /><hr /><br /><br />
...
export default WoodenSingleLeafDoor7q;