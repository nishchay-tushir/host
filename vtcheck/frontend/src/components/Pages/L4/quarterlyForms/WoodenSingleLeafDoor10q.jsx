...
const WoodenSingleLeafDoor10q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/wooden_single_leaf_door_10_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/wooden_single_leaf_door_10_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Door-Wooden single leaf- Admin office</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/ADOFF/WSLD/6213)</h1>
      <hr /><hr /><br /><br />
...
export default WoodenSingleLeafDoor10q;