...
const InhouseLight79q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/inhouse_lights_79_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/inhouse_lights_79_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Inhouse Light-79</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Inhouse Tubelight -Functional Lab</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/BOOM/TUB/6286)</h1>
      <hr /><hr /><br /><br />
...
export default InhouseLight79q;