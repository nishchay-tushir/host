...
const SoftnerPlant1q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/softener_plant_1_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/softener_plant_1_q', formData)
      .then(response => {
