...
const CassetteAC14q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/cassette_ac_14_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/cassette_ac_14_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Cassette AC-14</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Cassette AC-Mechanical office</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/MECHAOFF/CAB1/CAC/182 TO 186)</h1>
      <hr /><hr /><br /><br />
