...
const CassetteAC31q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/cassette_ac_31_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/cassette_ac_31_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Cassette AC-31</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Cassette AC 2 - Suprime</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/SUPCONFR/CAAC-2/6265)</h1>
      <hr /><hr /><br /><br />
