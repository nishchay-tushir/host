...
const FireHydrant6q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/fire_hydrant_6_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/fire_hydrant_6_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Fire hydrant-6</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Fire Hydrant Hose Reel-Electronic  Area-(1 TO 10 nos)</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/FH/ELECT/HR/3183 TO 3192)</h1>
      <hr /><hr /><br /><br />
