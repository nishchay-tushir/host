...
const MotorisedSlidingGate1q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/motorised_sliding_gate_1_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/motorised_sliding_gate_1_q', formData)
      .then(response => {
...
export default MotorisedSlidingGate1q;