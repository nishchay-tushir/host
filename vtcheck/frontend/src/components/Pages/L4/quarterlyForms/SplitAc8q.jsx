...
const SplitAC8q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/split_ac_8_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/split_ac_8_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> SPLIT AC-8</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Split AC-Wear house-Outward office</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO:VT/FM/UTM/WH/OUTWOFF/SPLAC/5971)</h1>
      <hr /><hr /><br /><br />
