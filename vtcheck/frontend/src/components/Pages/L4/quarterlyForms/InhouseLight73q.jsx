...
const InhouseLight73q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/inhouse_lights_73_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/inhouse_lights_73_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Inhouse Light-73</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : In-house tube light-Main gate-Security cabin</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/MG/SECC/TL/5880 TO 5882)</h1>
      <hr /><hr /><br /><br />
...
export default InhouseLight73q;