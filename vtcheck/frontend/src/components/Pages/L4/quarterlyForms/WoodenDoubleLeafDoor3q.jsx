...
const WoodenDoubleLeafDoor3q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/wooden_double_leaf_door_3_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/wooden_double_leaf_door_3_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Door-UTM Office inside- Panel room-Wooden double leaf door</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/UTMOFF/INS/PANRM/WDLD/5322)</h1>
      <hr /><hr /><br /><br />
...
export default WoodenDoubleLeafDoor3q;