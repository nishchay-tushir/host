...
const RollingShutter12q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/rolling_shutter_12_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/rolling_shutter_12_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Rolling shutter-12</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME :Rolling shutter-way from WH to Electronic area-2</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/ROLLSHUTTER-WHTOELECTRO2/6176 )</h1>
      <hr /><hr /><br /><br />
...
export default RollingShutter12q;