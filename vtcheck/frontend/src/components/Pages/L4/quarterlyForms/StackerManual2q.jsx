...
const Stacker2q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/stacker_manual_2_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/stacker_manual_2_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Stacker-Manual operated</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Stacker-Manual operate-Mechanical area-1 & 2</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/MECHAA/MOSTKR/5480 TO 5481)</h1>
      <hr /><hr /><br /><br />
