...
const Ups15q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/ups_15_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/ups_15_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : UPS - 400 KVA</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(Equipment no: VT/FM/UTM/UPS400KVA-TPHLI/6272)</h1>
      <hr /><hr /><br /><br />
