...
const StpRingBlower3q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/stp_ring_blower_3_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/stp_ring_blower_3_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>STP Ring Blower-3</h1>
      <h1 className='text-xl font-semibold text-center'>Equipment Name: STP Ring Blower-3</h1>
...
export default StpRingBlower3q;