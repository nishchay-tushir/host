...
const Ldb9q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/ldb_9_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/ldb_9_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : LDB Panel-2-Mech. Near Powder Re-Check Room </h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/MECHPRCA/LDBP/281)</h1>
      <hr /><hr /><br /><br />
