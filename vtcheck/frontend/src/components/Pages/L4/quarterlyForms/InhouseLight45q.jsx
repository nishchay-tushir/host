...
const InhouseLight45q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/inhouse_lights_45_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/inhouse_lights_45_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Inhouse Light-45</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : In-house Tube light- Changing room-1 (Mecha)- wash room area-G </h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/MECHA/CHR1/WR-G/TL/5039 TO 5056)</h1>
      <hr /><hr /><br /><br />
...
export default InhouseLight45q;