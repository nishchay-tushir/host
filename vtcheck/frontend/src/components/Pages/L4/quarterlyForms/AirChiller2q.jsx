...
const AirChiller2q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/air_chiller_2_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/air_chiller_2_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Air cooled chiller-2</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Air cooled chiller-2 </h1>
