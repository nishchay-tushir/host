...
const InhouseLight75q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/inhouse_lights_75_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/inhouse_lights_75_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Inhouse Light-75</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : In-house tube light-Check meter area ( 1 TO 4 nos.)</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/CHK/MTRA/TL/5890 TO 5893)</h1>
      <hr /><hr /><br /><br />
...
export default InhouseLight75q;