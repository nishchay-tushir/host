...
const GlassDoubleLeafDoor1q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/glass_double_leaf_door_1_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/glass_double_leaf_door_1_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Door-Admin Building-Reception-Glass double leaf door</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/ADB/RECPA/GDLD/5278 TO 5305)</h1>
      <hr /><hr /><br /><br />
...
export default GlassDoubleLeafDoor1q;