...
const InhouseLight99q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/inhouse_lights_99_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/inhouse_lights_99_q', formData)
      .then(response => {
  ...
  return (  
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Inhouse Light-99</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Inhouse Tubelight Lucar</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/BOOM/TUB/6306)</h1>
      <hr /><hr /><br /><br />
...
export default InhouseLight99q;