...
const InhouseLight33q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/inhouse_lights_33_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/inhouse_lights_33_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Inhouse Light-33</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : In-house Ceiling LED Linear light-Ware house Office</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/WH/OFF/CL/4709 TO 4756)</h1>
      <hr /><hr /><br /><br />
...
export default InhouseLight33q;