...
const SmokeDetector1q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/smoke_detector_1_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/smoke_detector_1_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Smoke Detector-1</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Smoke Detector-Warehouse roof  level ,Penthouse,Pump room & Security Cabin</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/SEC/PH/WH/SD/3042)</h1>
      <hr /><hr /><br /><br />
...
export default SmokeDetector1q;