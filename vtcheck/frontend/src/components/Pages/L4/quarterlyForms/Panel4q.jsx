...
const Panel4q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/panel_4_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/panel_4_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO:VT/FM/UTM/WCCPanel/115)</h1>
      <hr /><hr /><br /><br />
