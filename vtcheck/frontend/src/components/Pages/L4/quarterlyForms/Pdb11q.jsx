...
const Pdb11q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/pdb_11_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/pdb_11_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : PDB Panel- Pump House</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/PH/PDBP/299)</h1>
      <hr /><hr /><br /><br />
