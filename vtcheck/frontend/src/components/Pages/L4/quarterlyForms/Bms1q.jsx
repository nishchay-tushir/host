...
const Bms1q = () => {
  ...
  const dropdownLabels = [  'Check power supply (Acceptance Criteria - ON)',
    'Check battery signal in green zone  (Acceptance Criteria - Green zone)',
    'check any abnormal noise  (Acceptance Criteria - No noise)',
    'Check the monitor (Acceptance Criteria - ON )',
    'All CCTV display are running if not mention area name  (Acceptance Criteria - Running)',
    'Check the UPS power for all PCs (Acceptance Criteria - On)',
    'Check the Data care system (Acceptance Criteria - On )',
    'Check the power supply unit for spot cameras  (Acceptance Criteria - ON )',
    'Check room tempreture  (Acceptance Criteria - 22-24° C)',
    'Check the video recording system (Acceptance Criteria - ON)',
    'Check the Amplifire (Acceptance Criteria - ON)',
    'Check the camera rotation and direction (Acceptance Criteria - ON)',
    'Check spot camera status (Acceptance Criteria - ON)',
    'Check the alarm control   (Acceptance Criteria - OK)',
    'Check water leak detection panel (Acceptance Criteria - Ready)',
    'Check the manual call points (Acceptance Criteria - OK)',
    'Check all readers on indication (Acceptance Criteria - ON)',
    'Check all door working condition (Acceptance Criteria - Running)', 
    'Check the power supply (Acceptance Criteria - On)', 
    'Check the NVR Status (Acceptance Criteria - On)', 
    'Check the Mic (Acceptance Criteria - On)', 
    'Check the speakers (Acceptance Criteria - On)', 
  ]; 
  
  useEffect(() => {
    // Fetch submission status for the current quarter
    axios.get('https://scheq.in/api/bms_1_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/bms_1_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : BMS</h1>
