...
const FrpDoor13q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/frp_door_13_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/frp_door_13_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : FRP door-Ware house-1st floor-wash room-G</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/WH/1STF/WR-G/FRPD/5678 TO 5680)</h1>
      <hr /><hr /><br /><br />
