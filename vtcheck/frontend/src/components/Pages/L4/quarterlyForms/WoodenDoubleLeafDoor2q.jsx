...
const WoodenDoubleLeafDoor2q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/wooden_double_leaf_door_2_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/wooden_double_leaf_door_2_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Door-DOJO room area main entry- Wooden double leaf door</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/DOJOR/AETR/WDLD/5317 TO 5318)</h1>
      <hr /><hr /><br /><br />
...
export default WoodenDoubleLeafDoor2q;