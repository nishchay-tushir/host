...
const InhouseLight26q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/inhouse_lights_26_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/inhouse_lights_26_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Inhouse Light-26</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : In-house ceiling light-QA- NOX Lab</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/QA/NOXL/CL/4491 TO 4513)</h1>
      <hr /><hr /><br /><br />
...
export default InhouseLight26q;