...
const FireHydrant9q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/fire_hydrant_9_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/fire_hydrant_9_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Fire hydrant-9</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Fire Hydrant Hose Reel-Pent House L1-(1,2)</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/FH/PHL1/HR/3213 TO 3214 )</h1>
      <hr /><hr /><br /><br />
