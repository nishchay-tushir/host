...
const Ups17q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/ups_17_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/ups_17_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : UPS -Step up</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(Equipment no: VT/FM/UTM/BOOM/STEPUP/6283)</h1>
      <hr /><hr /><br /><br />
