...
const BeamDetector8q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/beam_detector_8_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/beam_detector_8_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Beam Detector-8</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Beam detector reflector-Admin building Area  </h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/AB/BDR/3059)</h1>
      <hr /><hr /><br /><br />
