...
const InhouseLight64q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/inhouse_lights_64_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/inhouse_lights_64_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Inhouse Light-64</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : In-house LED Linear light-Fire hydrant room external-Fore tank side </h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/EX/FHR/LEDL/5779)</h1>
      <hr /><hr /><br /><br />
...
export default InhouseLight64q;