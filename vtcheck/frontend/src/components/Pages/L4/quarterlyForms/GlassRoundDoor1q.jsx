...
const GlassRoundDoor1q = () => {
  ...
  const dropdownLabels = [  'Check door for any damage (Acceptance Criteria - No damage)',
    'Check push bar condition  (Acceptance Criteria - Tighten)',
    'Check dust cleaning brush (Acceptance Criteria - Good in condition)',
    ...
    'Check side guard glass case (Acceptance Criteria - Good in condition & tighten )',
    'Check for cleaning  (Acceptance Criteria - Clean)',
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/glass_round_door_1_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/glass_round_door_1_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Glass round door</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Glass round door</h1>
...
export default GlassRoundDoor1q;