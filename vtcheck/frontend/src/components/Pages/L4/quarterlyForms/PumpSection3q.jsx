...
const PumpSection3q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/pump_section_3_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/pump_section_3_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Pump Section-3</h1>
      <h1 className='text-xl font-semibold text-center'>Equipment Name: Pump Section FHS Pressure Pump- Sprinckler</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(Equipment no: VT/FM/UTM/FHS/SPP/3003)</h1>
      <hr /><hr /><br /><br />
