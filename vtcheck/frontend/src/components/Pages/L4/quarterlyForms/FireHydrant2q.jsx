...
const FireHydrant2q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/fire_hydrant_2_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/fire_hydrant_2_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Fire hydrant-2</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Fire Hydrant Post -External- Single Headed-(1 TO 23 nos)</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/FHP/EX-DH/3148 TO 3170)</h1>
      <hr /><hr /><br /><br />
