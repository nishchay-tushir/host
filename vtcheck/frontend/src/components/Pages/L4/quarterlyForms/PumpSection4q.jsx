...
const PumpSection4q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/pump_section_4_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/pump_section_4_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Pump Section-4</h1>
      <h1 className='text-xl font-semibold text-center'>Equipment Name: Pump Section FHS Pressure Pump-Hydrant</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(Equipment no: VT/FM/UTM/FHS/HPP/3004)</h1>
      <hr /><hr /><br /><br />
