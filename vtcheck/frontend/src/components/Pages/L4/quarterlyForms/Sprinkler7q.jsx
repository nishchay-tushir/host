...
const Sprinkler7q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/sprinkler_7_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/sprinkler_7_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Sprinkler-7</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Sprinckler-Technical penthouse </h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/TPH/SPRI/3030 TO 3037)</h1>
      <hr /><hr /><br /><br />
