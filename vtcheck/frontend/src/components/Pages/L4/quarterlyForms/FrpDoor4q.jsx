...
const FrpDoor4q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/frp_door_4_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/frp_door_4_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : FRP Door-Electronic change room-wash room-L</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/ELECT/CHR/WR-L/FRPD/5508 TO 5514)</h1>
      <hr /><hr /><br /><br />
