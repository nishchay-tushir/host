...
const StpPump1q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/stp_pump_1_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/stp_pump_1_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> STP Pump-1</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : STP Pump-1</h1>
