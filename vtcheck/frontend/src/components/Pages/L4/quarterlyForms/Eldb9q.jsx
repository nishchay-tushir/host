...
const Eldb9q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/eldb_9_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/eldb_9_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : ELDB Panel- Admin Buld. Store Room</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/ABST/ELDBP/288)</h1>
      <hr /><hr /><br /><br />
