...
const GardenPump1q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/garden_pump_1_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/garden_pump_1_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold mb-6 text-center'>(VT/FM/UTM/STP/GARD/PUMP/5248)</h1>
      <hr /><hr /><br /><br />
