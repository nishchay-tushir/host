...
const SplitAC22q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/split_ac_22_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/split_ac_22_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> SPLIT AC-22</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Split AC -Functional lab</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/BOOM/SPAC/6308)</h1>
      <hr /><hr /><br /><br />
