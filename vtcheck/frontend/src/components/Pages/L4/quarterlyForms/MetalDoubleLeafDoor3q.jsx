...
const MetalDoubleLeafDoor3q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/metal_double_leaf_door_3_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/metal_double_leaf_door_3_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Door-WRC room-Metal double leaf door</h1>
...
export default MetalDoubleLeafDoor3q;