...
const SwagonCompressor1q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/swegon_compressor_1_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/swegon_compressor_1_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Swagon Compressor</h1>
...
export default SwagonCompressor1q;