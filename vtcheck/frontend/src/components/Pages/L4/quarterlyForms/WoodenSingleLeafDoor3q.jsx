...
const WoodenSingleLeafDoor3q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/wooden_single_leaf_door_3_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/wooden_single_leaf_door_3_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Door-DOJO room-towards steir case- Wooden single leaf door</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/DOJOR/TO/STRC/WSLD/5323)</h1>
      <hr /><hr /><br /><br />
...
export default WoodenSingleLeafDoor3q;