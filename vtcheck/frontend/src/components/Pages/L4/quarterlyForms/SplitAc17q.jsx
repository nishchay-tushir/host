...
const SplitAC17q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/split_ac_17_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/split_ac_17_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> SPLIT AC-17</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Split AC-TPHL I- Server room AC-1</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO:VT/FM/UTM/TPHL I/SWACOMPRM/SPLAC1/6201)</h1>
      <hr /><hr /><br /><br />
