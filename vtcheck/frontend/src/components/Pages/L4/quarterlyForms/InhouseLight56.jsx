...
const InhouseLight56q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/inhouse_lights_56_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/inhouse_lights_56_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Inhouse Light-56</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : In-house light-Admin building-passage way to table tanis play room-Tube light </h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/ADB/PWT/TTPR/TL/5394 TO 5409)</h1>
      <hr /><hr /><br /><br />
...
export default InhouseLight56q;