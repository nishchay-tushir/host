...
const ManualCallPt5q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/manual_call_point_5_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/manual_call_point_5_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Manual call point-5</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Manual Call Point-Admin building Area </h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/AB/MCP/3051)</h1>
      <hr /><hr /><br /><br />
