...
const GlassDoubleLeafDoor2q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/glass_double_leaf_door_2_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/glass_double_leaf_door_2_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Door- QA lab entry- Glass double leaf door-1 & 2</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/QAL/ETY1/GDLD/5332 TO 5333)</h1>
      <hr /><hr /><br /><br />
...
export default GlassDoubleLeafDoor2q;