...
const CassetteAC12q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/cassette_ac_12_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/cassette_ac_12_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Cassette AC-12</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Cassette AC-Mechanical-water drink room</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/MECHA/WATDR/CAC/180)</h1>
      <hr /><hr /><br /><br />
