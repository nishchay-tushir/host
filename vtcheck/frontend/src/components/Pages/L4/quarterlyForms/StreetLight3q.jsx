...
const StreetLight3q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/street_lights_3_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/street_lights_3_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Street Light -3</h1>
