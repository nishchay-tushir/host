...
const StackerBattery1q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/stacker_battery_1_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/stacker_battery_1_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO:VT/FM/UTM/WHA/BOSTKR/206)</h1>
      <hr /><hr /><br /><br />
...
export default StackerBattery1q;