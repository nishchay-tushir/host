...
const InhouseLight12q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/inhouse_lights_12_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/inhouse_lights_12_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Inhouse Light-12</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : In-house Tube light-Electronic-Maintenance office passage area </h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FN/UTM/ELECET/MAINTOF/TL/4152 TO 4155)</h1>
      <hr /><hr /><br /><br />
...
export default InhouseLight12q;