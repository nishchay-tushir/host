...
const HooterCumStrobe1q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/hooter_cum_strobe_1_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/hooter_cum_strobe_1_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Hooter Cum Strobe-1</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME :  Hooter cum strobe-Warehouse roof  level ,Penthouse,Pump room & Security Cabin</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/SEC/PH/WH/HCS/3060)</h1>
      <hr /><hr /><br /><br />
...
export default HooterCumStrobe1q;