...
const WoodenSingleLeafDoor8q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/wooden_single_leaf_door_8_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/wooden_single_leaf_door_8_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Door-Main gate security cabin- wooden single leaf door</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/MG/SECC/WSLD/5484 TO 5485)</h1>
      <hr /><hr /><br /><br />
...
export default WoodenSingleLeafDoor8q;