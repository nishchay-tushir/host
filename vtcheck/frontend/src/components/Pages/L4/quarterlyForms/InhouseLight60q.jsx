...
const InhouseLight60q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/inhouse_lights_60_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/inhouse_lights_60_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Inhouse Light-60</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : In-house Ceiling LED Linear light-Compressor room-L1 TO L4 </h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/COMPR/CELL/L1/5691 TO L4/5714)</h1>
      <hr /><hr /><br /><br />
...
export default InhouseLight60q;