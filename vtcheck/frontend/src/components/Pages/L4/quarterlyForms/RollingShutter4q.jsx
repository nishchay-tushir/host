...
const RollingShutter4q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/rolling_shutter_4_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/rolling_shutter_4_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Rolling shutter-4</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME :Rolling shutter- Fire pump room</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/FPR/RS/234 )</h1>
      <hr /><hr /><br /><br />
...
export default RollingShutter4q;