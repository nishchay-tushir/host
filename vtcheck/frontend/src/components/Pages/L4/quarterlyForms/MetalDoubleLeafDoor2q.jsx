...
const MetalDoubleLeafDoor2q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/metal_double_leaf_door_2_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/metal_double_leaf_door_2_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Door-CMM area entry- Metal double leaf door</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/CMMR/ETY/MDLD/5326)</h1>
      <hr /><hr /><br /><br />
...
export default MetalDoubleLeafDoor2q;