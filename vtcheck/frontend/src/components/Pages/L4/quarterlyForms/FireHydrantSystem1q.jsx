...
const FireHydrantSystem1q = () => {
  ...
  const dropdownLabels = [  'Use LOTO before start start of the work at incomer supply (Acceptance Criteria - Lock out with life tag)',
    ...
    'Check Filter condition (Acceptance Criteria - Clogged)',
    ...
    'Apply the greese on to the Studs (Acceptance Criteria -Apply grease)',
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/fire_hydrant_system_1_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/fire_hydrant_system_1_q', formData)
      .then(response => {
...
export default FireHydrantSystem1q;