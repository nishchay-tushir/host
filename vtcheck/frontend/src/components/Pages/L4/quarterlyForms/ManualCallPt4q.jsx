...
const ManualCallPt4q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/manual_call_point_4_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/manual_call_point_4_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Manual call point-4</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Manual Call Point-Technical Penthouse Area </h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/TPH/MCP/3050)</h1>
      <hr /><hr /><br /><br />
