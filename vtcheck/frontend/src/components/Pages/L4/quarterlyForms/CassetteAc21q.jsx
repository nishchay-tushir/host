...
const CassetteAC21q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/cassette_ac_21_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/cassette_ac_21_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Cassette AC-21</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Cassette AC-Admin building-IInd flr-cabin 1 TO 15</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/ADBLG/IINDFR/CAC/CAB1/5976 TO 5990)</h1>
      <hr /><hr /><br /><br />
