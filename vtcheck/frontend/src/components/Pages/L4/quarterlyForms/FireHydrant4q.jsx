...
const FireHydrant4q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/fire_hydrant_4_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/fire_hydrant_4_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Fire hydrant-4</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Fire Hydrant Hose Reel-Admin Building-L1 Stair</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/FH/AB-L1S/HR/3175 TO 3178)</h1>
      <hr /><hr /><br /><br />
