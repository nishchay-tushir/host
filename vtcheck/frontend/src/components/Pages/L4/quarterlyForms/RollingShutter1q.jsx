...
const RollingShutter1q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/rolling_shutter_1_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/rolling_shutter_1_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Rolling shutter-1</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME :Rolling shutter-Mecha. Shop (1,2,3)</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/MECHA/RS/228 TO 230 )</h1>
      <hr /><hr /><br /><br />
...
export default RollingShutter1q;