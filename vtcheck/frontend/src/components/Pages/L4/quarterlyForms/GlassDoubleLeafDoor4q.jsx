...
const GlassDoubleLeafDoor4q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/glass_double_leaf_door_4_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/glass_double_leaf_door_4_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Glass double leaf door</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Door-Electronic area-Office-Mechanical tool room entry-Glass double leaf door</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/ELECT/WTMECHATR/GDLD/5368 TO 5385)</h1>
      <hr /><hr /><br /><br />
...
export default GlassDoubleLeafDoor4q;