...
const DdcPanel1q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/ddc_panel_1_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/ddc_panel_1_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> DDC Panel-1 </h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : DDC Panel-1- PHL1</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO:VT/FM/UTM/PHL1/DDCP/301 TO 303)</h1>
      <hr /><hr /><br /><br />
