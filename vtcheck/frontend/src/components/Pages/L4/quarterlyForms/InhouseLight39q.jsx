...
const InhouseLight39q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/inhouse_lights_39_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/inhouse_lights_39_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Inhouse Light-39</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : In-house Ceiling LED Linear light-Admin B. Reception Area </h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/ADMB/RECA/CLED/4894 TO 4925)</h1>
      <hr /><hr /><br /><br />
...
export default InhouseLight39q;