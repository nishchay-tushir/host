...
const InhouseLight58q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/inhouse_lights_58_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/inhouse_lights_58_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Inhouse Light-58</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : In-house light-Ware house-1st floor-wash room-M-Tube light </h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/WH/1STF/WR-M/TL/5664 TO 5670)</h1>
      <hr /><hr /><br /><br />
...
export default InhouseLight58q;