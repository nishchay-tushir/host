...
const StackerBattery4q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/stacker_battery_4_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/stacker_battery_4_q', formData)
      .then(response => {
...
export default StackerBattery4q;