...
const GlassDoubleLeafDoor6q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/glass_double_leaf_door_6_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/glass_double_leaf_door_6_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Door-Glass double leaf- Admin office</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/ADOFF/GDLD/6211)</h1>
      <hr /><hr /><br /><br />
...
export default GlassDoubleLeafDoor6q;