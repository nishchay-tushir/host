...
const HooterCumStrobe4q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/hooter_cum_strobe_4_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/hooter_cum_strobe_4_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Hooter Cum Strobe-4</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME :  Hooter cum strobe-Admin building Area</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/AB/HCS/3063)</h1>
      <hr /><hr /><br /><br />
...
export default HooterCumStrobe4q;