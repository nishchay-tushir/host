...
const WoodenDoubleLeafDoor1q = () => {
  ...
  const dropdownLabels = [  'Check door for any damage (Acceptance Criteria - No damage)',
    ...
    'Check door stopper  (Acceptance Criteria - Good in condition & Tighten )',
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/wooden_double_leaf_door_1_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/wooden_double_leaf_door_1_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Wooden double leaf door</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Door-Electronic area-Changing room-L-Wooden double leaf door</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/ELCET/CHR-L/WDLD/5206 TO 5316)</h1>
      <hr /><hr /><br /><br />
...
export default WoodenDoubleLeafDoor1q;