...
const Pdb8q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/pdb_8_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/pdb_8_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : PDB Panel-(1,2)- Admin Buld. Store Room</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/ABST/PDBP/289 TO 290)</h1>
      <hr /><hr /><br /><br />
