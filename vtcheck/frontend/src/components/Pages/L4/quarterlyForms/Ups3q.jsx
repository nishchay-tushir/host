...
const Ups3q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/ups_3_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/ups_3_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : UPS -3 (250 kva) (SR NO. P1201948129386)</h1>
