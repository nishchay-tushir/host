...
const Ups4q = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/ups_4_q/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/ups_4_q', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : UPS - 4 (250 kva) (SR NO. P1201936121960)</h1>
