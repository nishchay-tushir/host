...
const AirCompressor1tb = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/air_compressor_1_tb/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/air_compressor_1_tb', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold mb-6 text-center'>(Equipment no: VT/FM/UTM/AC1653CFM/082)</h1>
      <hr /><hr /><br /><br />
...
export default AirCompressor1tb;