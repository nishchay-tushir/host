...
const DG10102tb = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/dg_1010_2_tb/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/dg_1010_2_tb', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> D.G.-3- 1010 KVA ESN NO.- 25431786</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : D.G.-3- 1010 KVA ESN NO.- 25431786</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO:  VT/FM/UTM/DG/1010KVA/6180)</h1>
      <hr /><hr /><br /><br />
