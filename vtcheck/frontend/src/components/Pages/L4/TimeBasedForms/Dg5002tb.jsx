...
const DG5002tb = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/dg_500_2_tb/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/dg_500_2_tb', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> D.G.-5- 500 KVA ESN NO- 25334984</h1>
