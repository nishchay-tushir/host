...
const WaterChiller1tb = () => {
  ...
  const dropdownLabels = [  'Use LOTO before start start of the work at incomer supply (Acceptance Criteria - Lock out with life tag)',
    'check outer body condition (Acceptance Criteria - No damage)',
    'check & maintain the  oil level  (Acceptance Criteria - Maximim)',
    ...
    'Apply grease where necessary (Acceptance Criteria - Oil & Grease)',
    'Check for corrosion of parts (Acceptance Criteria - No corrosion) ',
    'Check the heat exchanger  (Acceptance Criteria - Clean )',
    'Check insulation for any damage  (Acceptance Criteria - No damage)',
    'Electrical components and cabling  (Acceptance Criteria - Proper)',
    'Check all valve condition  (Acceptance Criteria - No damage )',
    'Check for all electrical connections for tightening (Acceptance Criteria - Tighten if found loose)',
    'Check all electrical connectins for tightness (Acceptance Criteria - Tighten if found loose)',
    'Check any leakage of water  (Acceptance Criteria - No Leakage)',
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/water_chiller_1_tb/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/water_chiller_1_tb', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Water cooler -1</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Water cooled Chiller Unit 1 </h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/WCC/088)</h1>
...
export default WaterChiller1tb;