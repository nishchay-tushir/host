...
const AirDryer1tb = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/air_dryer_1_tb/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/air_dryer_1_tb', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Air Dryer-1 ( FD1500VSD+)</h1>
