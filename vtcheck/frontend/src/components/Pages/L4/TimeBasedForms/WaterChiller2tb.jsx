...
const WaterChiller2tb = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/water_chiller_2_tb/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/water_chiller_2_tb', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Water cooler -2</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Water cooled Chiller Unit 2 </h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/WCC/089)</h1>
...
export default WaterChiller2tb;