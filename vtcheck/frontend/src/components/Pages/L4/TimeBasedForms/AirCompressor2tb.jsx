...
const AirCompressor2tb = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/air_compressor_2_tb/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/air_compressor_2_tb', formData)
      .then(response => {
...
export default AirCompressor2tb;