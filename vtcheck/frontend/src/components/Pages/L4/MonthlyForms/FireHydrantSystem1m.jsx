...
const FireHydrantSystem1m = () => {
  ...
  const dropdownLabels = [  'Use LOTO before start start of the work at incomer supply (Acceptance Criteria - Lock out with life tag)',
    'Check & Clean the area  (Acceptance Criteria - Clean)',
    'Check for any leakage of water through the pipes or gate valve (Acceptance Criteria - No leakage)',
    'Check all pressure gauges condition & tightness (Acceptance Criteria - Good & Tighten)',
    'Apply Grease to the Screw of the Gate valve (Acceptance Criteria - Gressing)',
    'Check coupler condition of pump & motor (Acceptance Criteria - Ok )',
    'Check battery terminal (Acceptance Criteria - Ok)',
    'Check all valve is in the open condition except drain line  (Acceptance Criteria -Open)',
    'Check all fire water line  (Acceptance Criteria - Ok )',
    'Clean all the unit (Acceptance Criteria - Clean)',
    'Take the trial of unit(Unit Trial) (Acceptance Criteria - Running Ok )',
    'Check for any abnormal vibration   (Acceptance Criteria - No vibration)',
    'Check for any abnormal  Noise  (Acceptance Criteria - Below 85db)',
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/fire_hydrant_system_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/fire_hydrant_system_1_m', formData)
      .then(response => {
...
export default FireHydrantSystem1m;