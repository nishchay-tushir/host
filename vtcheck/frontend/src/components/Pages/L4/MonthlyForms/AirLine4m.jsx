...
const AirLine4m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/air_line_4_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/air_line_4_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Air Line - 4</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Air Line (Mechanical Area)</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/MECHAA/AIRLINE/6234)</h1>
      <hr /><hr /><br /><br />
