...
const SwagonCompressor1m = () => {
  ...
  const dropdownLabels = [  'Use LOTO before start start of the work at incomer supply (Acceptance Criteria - Lock out with life tag)',
    'Check & Record the display parameter (Temperature)  (Acceptance Criteria - 25°C)',
    'Check and record the Humidity  (Acceptance Criteria - 60%)',
    'Check for any leakages  (Acceptance Criteria - No Leakage )',
    'Check the filter condition and clean the filter   (Acceptance Criteria - Clean by Blower)',
    'Check the cooling of the room area   (Acceptance Criteria - 25°C)',
    'Check for the leakage of refrigerant  (Acceptance Criteria - No Leakage )',
    'Check voltage(Multimeter)  (Acceptance Criteria - Below 2V )',
    'Check for the leakage of refrigerant line joints with Soap solution   (Acceptance Criteria - No Leakage)',
    'Clean the area near the Equipement  (Acceptance Criteria - Clean by Blower)',
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/swagon_compressor_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/swagon_compressor_1_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Swagon compressor</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Swagon Compressor-1 (Technical PH L-1)</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/TPHL-1/SWCO/086)</h1>
      <hr /><hr /><br /><br />
...
export default SwagonCompressor1m;