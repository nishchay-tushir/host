...
const GardenPump1m = () => {
  ...
  const dropdownLabels = [  'Use LOTO before start start of the work at incomer supply (Acceptance Criteria - Lock out with life tag)',
    ...
    'Check water leakage (Acceptance Criteria - OK & Tighten)',
    'check fan  (Acceptance Criteria - OK & Tighten & No damage)',
    ...
    'Check pump  (Acceptance Criteria - OK )',
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/garden_pump_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/garden_pump_1_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Garden Pump</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Garden Pump</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO:  VT/FM/UTM/STP/GARD/PUMP/5248 )</h1>
      <hr /><hr /><br /><br />
