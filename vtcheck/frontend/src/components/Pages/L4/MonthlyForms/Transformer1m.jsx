...
const Transformer1m = () => {
  ...
  const dropdownLabels = [  'Use LOTO before start start of the work at incomer supply (Acceptance Criteria - Lock out with life tag)',
    'Check relief vent diaphragm  (Acceptance Criteria - OK)',
    'Check oil level (Acceptance Criteria - Maximum)',
    'Check the dehydrating breather (Acceptance Criteria - Blue)',
    'Clean the transformer area (Acceptance Criteria - Clean)',
    'Check tap position (Acceptance Criteria - Auto )',
    'Check all electrical connection (Acceptance Criteria - Tighten)',
    'Check earthen connection  (Acceptance Criteria -Tighten)',
    'Check for any abnormal vibration / Noise  (Acceptance Criteria - Below 85db )',
    'Check the oil leakage (Acceptance Criteria - No leakage)',
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/transformer_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/transformer_1_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Transformer</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Transformer</h1>
