...
const WaterLine3m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/water_line_3_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/water_line_3_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Water Line - 3</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Process cooling water line (PHL -2 )</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/TPHL-IIA/PROCOOLLINE/6227)</h1>
      <hr /><hr /><br /><br />
