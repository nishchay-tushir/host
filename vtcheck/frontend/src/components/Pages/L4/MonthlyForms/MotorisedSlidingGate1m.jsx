...
const MotorisedSlidingGate1m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/motorised_sliding_gate_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/motorised_sliding_gate_1_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/MG/MSG/245)</h1>
      <hr /><hr /><br /><br />
...
export default MotorisedSlidingGate1m;