...
const FireExtinguisher175m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/fire_extinguisher_175_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/fire_extinguisher_175_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Fire Extinguisher-Utility area-safety store- Sr. No. 163</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/UTILITYA/SAFETYSTORE/FE-ABC/SRN.163/6171)</h1>
      <hr /><hr /><br /><br />
...
export default FireExtinguisher175m;