...
const GlassRoundDoor1m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/glass_round_door_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/glass_round_door_1_m', formData)
      .then(response => {
...
export default GlassRoundDoor1m;