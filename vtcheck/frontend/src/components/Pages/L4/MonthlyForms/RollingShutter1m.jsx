...
const RollingShutter1m = () => {
  ...
  const dropdownLabels = [  'Use LOTO before start start of the work at incomer supply (Acceptance Criteria - Lock out with life tag)',
    ...
    'Check for break system (Acceptance Criteria - OK )',
    'Apply oil & grease at rotating parts (Acceptance Criteria - Apply )',
    'check & tighten all the blots (Acceptance Criteria - Apply )',
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/rolling_shutter_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/rolling_shutter_1_m', formData)
      .then(response => {
...
export default RollingShutter1m;