...
const StreetLight2m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/street_lights_2_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/street_lights_2_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Street Light DB Panel-02- Mate. Gate Security Cabin</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/MGDC/SLDBP/294)</h1>
      <hr /><hr /><br /><br />
