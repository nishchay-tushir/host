...
const FireExtinguisher166m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/fire_extinguisher_166_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/fire_extinguisher_166_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Fire Extinguisher-DG area- Sr. No. 154</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/UTILITYA/DGYARD/FE-CO2/SRN.154/6162)</h1>
      <hr /><hr /><br /><br />
...
export default FireExtinguisher166m;