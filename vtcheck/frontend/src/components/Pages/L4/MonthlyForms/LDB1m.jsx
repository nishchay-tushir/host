...
const LDB1m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/ldb_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/ldb_1_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Street Light DB Panel-02- Mate. Gate Security Cabin</h1>
