...
const WccWaterMakeup1m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/water_makeup_unit_wcc_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/water_makeup_unit_wcc_1_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : WCC-make up Water unit</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO:  VT/FM/UTM/WCC/MU/WTRU/MTR1/5267)</h1>
      <hr /><hr /><br /><br />
...
export default WccWaterMakeup1m;