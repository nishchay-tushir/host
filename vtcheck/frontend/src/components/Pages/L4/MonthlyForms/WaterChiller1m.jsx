...
const WaterChiller1m = () => {
  ...
  const dropdownLabels = [  'Use LOTO before start start of the work at incomer supply (Acceptance Criteria - Lock out with life tag)',
    ...
    'check & maintain the  oil level - Maximim)',
    ...
    'Oiling & greasing the parts (Acceptance Criteria - Done)',
    ...
    'Check all motor voltages & amps, electrical starters, contactors, relays, and inspect unit grounding (Acceptance Criteria - OK)',
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/water_cooled_chiller_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/water_cooled_chiller_1_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Water cooled Chiller Unit 1</h1>
