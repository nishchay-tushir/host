...
const RapidRollingShutter12m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/rapid_rolling_shutter_12_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/rapid_rolling_shutter_12_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/WH/RRS/221)</h1>
      <hr /><hr /><br /><br />
...
export default RapidRollingShutter12m;