...
const SplitAC4m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/split_ac_4_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/split_ac_4_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Cassette AC- CMM Lab</h1>
