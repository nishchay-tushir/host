...
const StpPumpMotor1m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/stp_pump_motor_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/stp_pump_motor_1_m', formData)
      .then(response => {
