...
const AirLine2m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/air_line_2_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/air_line_2_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Air Line - 2</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Air Line (Electronis Area)</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/ELECTA/AIRLINE/6232)</h1>
      <hr /><hr /><br /><br />
