...
const WccWaterMakeup2m = () => {
  ...
  const dropdownLabels = [  'Use LOTO before start start of the work at incomer supply (Acceptance Criteria - Lock out with life tag)',
    ...
    'Check valve condition (Acceptance Criteria - Good in condition & working)',
    'Check all nuts, bolts, joints (Acceptance Criteria - OK & Tighten)',
    'Check panel box (Acceptance Criteria - Good in condition )',
    'Check all electrical connections  (Acceptance Criteria - OK & Tighten )',
    'Check motor condition & electrical connections (Acceptance Criteria - OK & Tighten)',
    'Check water tank (Acceptance Criteria -Leakage free/good in condition)',
    'Check inlet pipe line  (Acceptance Criteria - OK & Tighten )',
    'Check out let pipe line (Acceptance Criteria - OK & Tighten)',
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/water_makeup_unit_wcc_2_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/water_makeup_unit_wcc_2_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> WCC-make up Water unit</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : WCC-make up Water unit -Motor-1 & 2</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO:  VT/FM/UTM/WCC/MU/WTRU/MTR1/5268 TO 5269)</h1>
      <hr /><hr /><br /><br />
...
export default WccWaterMakeup2m;