...
const CoolingTower1m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/cooling_tower_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/cooling_tower_1_m', formData)
      .then(response => {
