...
const PanelWoAbc1m = () => {
  ...
  const dropdownLabels = [  'Use LOTO before start start of the work at incomer supply (Acceptance Criteria - Lock out with life tag)',
    ...
    'Checking of Contactor NO NC Point (Acceptance Criteria - OK)',
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/panel_wo_acb_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/panel_wo_acb_1_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Panel without ACB</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Panel wothout ACB</h1>
