...
const AirRecieverTank1m = () => {
  ...
  const dropdownLabels = [  'Check pressure clamping (Acceptance Criteria - Tighten)',
    ...
    'Check air outlet valve condition (Acceptance Criteria - No damage & all bolts are tight)',
    ...
    'Check foundation bolts  (Acceptance Criteria - Avalaible & tighten)',
    'Check air tank condition  (Acceptance Criteria - No damage)',
    'Clean the unit (Acceptance Criteria - 24 V)',
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/air_receiver_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/air_receiver_1_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Air receiver tank - 1</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Air receiver tank</h1>
...
export default AirRecieverTank1m;