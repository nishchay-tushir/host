...
const WaterLine2m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/water_line_2_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/water_line_2_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Water Line - 2</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Process cooling water line (PHL -1)</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/TPHL-IA/PROCOOLLINE/6226)</h1>
      <hr /><hr /><br /><br />
