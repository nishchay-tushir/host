...
const Canteen89m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/canteen_led_lights_89_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/canteen_led_lights_89_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Admin office light-ENSO - P 1800 DIA 76W 2.5 METER SUSPENSION KIT</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/ADOFF/CELL/6059)</h1>
      <hr /><hr /><br /><br />
