...
const Canteen74m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/canteen_led_lights_74_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/canteen_led_lights_74_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Admin office light-Xcent - 15W WD</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/ADOFF/CELL/6044)</h1>
      <hr /><hr /><br /><br />
