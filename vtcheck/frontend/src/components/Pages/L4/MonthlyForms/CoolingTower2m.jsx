...
const CoolingTower2m = () => {
  ...
  const dropdownLabels = [  'Use LOTO before start start of the work at incomer supply (Acceptance Criteria - Lock out with life tag)',
    'Check the operating oil level (Acceptance Criteria - H/M/L)',
    'Check water level of the cooling tower (Acceptance Criteria - H/M/L)',
    'Check for any damage to body (Acceptance Criteria - No damage)',
    'Apply oil & grease where necessary (Acceptance Criteria - Smooth operating)',
    'Check water pipe line for any damage (Acceptance Criteria - No damage )',
    'Check for any valve damage (Acceptance Criteria - No damage)',
    'Check fixing of the pump properly (Acceptance Criteria -OK)',
    'Check all nut bolts  (Acceptance Criteria - Tighten )',
    'check for deposits on fan blades/ fixing (Acceptance Criteria - Clean )',
    'check and insure Greasing properly fan bearings (Acceptance Criteria - Apply Grease )',
    'All the area should be clean (Acceptance Criteria - Clean )',
    'check and adjust check function (Blow-down)  (Acceptance Criteria - Blow-down )',
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/cooling_tower_2_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/cooling_tower_2_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Cooling Tower</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Cooling Tower - 2</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO:  VT/FM/UTM/CT/093)</h1>
      <hr /><hr /><br /><br />
