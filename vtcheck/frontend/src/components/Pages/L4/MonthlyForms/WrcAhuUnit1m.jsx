...
const WrcAhuUnit1m = () => {
  ...
  const dropdownLabels = [  'Use LOTO before start start of the work at incomer supply (Acceptance Criteria - Lock out with life tag)',
    'Check outside duct line  (Acceptance Criteria - No leakage, Proper hanging tightening)',
    'Check inside duct line (Acceptance Criteria - No leakage, Proper support)',
    'Check foundation bolts  (Acceptance Criteria - OK & Tighten)',
    'Check outdoor unit  (Acceptance Criteria - Clean, noiseless operation )',
    'Check the unit  (Acceptance Criteria - No damage )',
    'Clean the air suction filter (Acceptance Criteria - OK & Tighten )',
    'Check cooling coil (Acceptance Criteria - Clean  )',
    'Check electricals connections of motor  (Acceptance Criteria - OK & Tighten)',
    'Check motor,pulley & belt  (Acceptance Criteria - OK & Tighten)',
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/wrc_room_ahu_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/wrc_room_ahu_1_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> WRC room AHU unit</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : WRC room AHU unit</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO:  VT/FM/UTM/WRCR/AHU/6102 )</h1>
      <hr /><hr /><br /><br />
