...
const FireWaterLine6m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/fire_water_line_6_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/fire_water_line_6_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Fire Water Line - 6</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Fire water line (Outer periferi)</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/OUTERA/FIRELINE/6223)</h1>
      <hr /><hr /><br /><br />
...
export default FireWaterLine6m;