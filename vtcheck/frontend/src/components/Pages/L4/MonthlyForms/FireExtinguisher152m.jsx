...
const FireExtinguisher152m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/fire_extinguisher_152_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/fire_extinguisher_152_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Fire Extinguisher-Technical PHL-I Sr. No. 139</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/TPH-I/FE-ABC/SRN.139/6148)</h1>
      <hr /><hr /><br /><br />
...
export default FireExtinguisher152m;