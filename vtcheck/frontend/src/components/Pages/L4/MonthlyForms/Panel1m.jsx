...
const Panel1m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/panel_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/panel_1_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Panel-32</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Panel - 32 (VFD + star delta panel for standby process loop system)</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/PANEL-STBYPROCESSLOOPSYS/TPHLII/6255)</h1>
      <hr /><hr /><br /><br />
