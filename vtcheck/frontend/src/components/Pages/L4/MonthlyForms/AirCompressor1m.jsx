...
const AirCompressor1m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/air_compressor_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/air_compressor_1_m', formData)
      .then(response => {
...
export default AirCompressor1m;