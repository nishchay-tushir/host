...
const Pump2m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/pump_2_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/pump_2_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Pump Section for ACC-1</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(Equipment no: VT/FM/UTM/WCC/PUMP1/5272)</h1>
      <hr /><hr /><br /><br />
