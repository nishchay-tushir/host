...
const AirLine3m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/air_line_3_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/air_line_3_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Air Line - 3</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Air Line (Utility Area)</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/UTILITYA/AIRLINE/6233)</h1>
      <hr /><hr /><br /><br />
