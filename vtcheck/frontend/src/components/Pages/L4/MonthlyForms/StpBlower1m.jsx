...
const StpBlower1m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/stp_blower_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/stp_blower_1_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>STP Ring Blower</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : STP Ring Blower-1,2,3 & 4</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO:  VT/FM/UTM/STP/BLER1/5253 TO 5256)</h1>
      <hr /><hr /><br /><br />
