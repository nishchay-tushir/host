...
const StpPump1m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/stp_pump_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/stp_pump_1_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> STP pump </h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : STP pump-1 & 2</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO:  VT/FM/UTM/STP/PUMP1/5249 TO 5250 )</h1>
      <hr /><hr /><br /><br />
