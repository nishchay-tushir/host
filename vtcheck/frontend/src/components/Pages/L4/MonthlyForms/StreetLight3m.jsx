...
const StreetLight3m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/street_lights_3_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/street_lights_3_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Street Light Pole- Main gate-Single Light</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/MG/SL/SIL/3223 TO 3243)</h1>
      <hr /><hr /><br /><br />
