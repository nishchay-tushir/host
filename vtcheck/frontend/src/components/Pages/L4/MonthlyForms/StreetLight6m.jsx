...
const StreetLight6m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/street_lights_6_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/street_lights_6_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Street Light Pole-Ware house- Dock yard-Double light</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/WH-DY/ST//DOL/3275 TO 3296)</h1>
      <hr /><hr /><br /><br />
