...
const SoftnerMotor1m = () => {
  ...
  const dropdownLabels = [  'Use LOTO before start start of the work at incomer supply (Acceptance Criteria - Lock out with life tag)',
    ...
    'Check motor body (Acceptance Criteria - OK & Tighten)',
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/softener_motor_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/softener_motor_1_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>STP pump motor</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : STP pump motor-1 & 2</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO:  VT/FM/UTM/STP/MTR1/5251 TO 5252:)</h1>
      <hr /><hr /><br /><br />
