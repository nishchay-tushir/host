...
const AccWaterMakeup1m = () => {
  ...
  const dropdownLabels = [  'Use LOTO before start start of the work at incomer supply (Acceptance Criteria - Lock out with life tag)',
    ...
    'Check water meter (Acceptance Criteria - OK & Tighten)',
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/water_makeup_unit_acc_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/water_makeup_unit_acc_1_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'> Water make-up unit for Air cooled chiller</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Water make-up unit for Air cooled chiller</h1>
...
export default AccWaterMakeup1m;