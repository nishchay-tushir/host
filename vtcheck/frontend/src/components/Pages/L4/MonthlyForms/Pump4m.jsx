...
const Pump4m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/pump_4_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/pump_4_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Submerssible Pump-1,2 & 3</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(Equipment no: VT/FM/UTM/SUBMP/PUMP1/5244 TO 5246)</h1>
      <hr /><hr /><br /><br />
