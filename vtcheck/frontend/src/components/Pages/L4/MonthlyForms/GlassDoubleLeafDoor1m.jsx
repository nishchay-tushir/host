...
const GlassDoubleLeafDoor1m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/glass_double_leaf_door_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/glass_double_leaf_door_1_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Glass double leaf door</h1>
...
export default GlassDoubleLeafDoor1m;