...
const Panel6m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/panel_6_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/panel_6_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Panel-37</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Panel - 37 EV charging station</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/EVCHARGSTN/MAINGATE/6260 TO 6263)</h1>
      <hr /><hr /><br /><br />
