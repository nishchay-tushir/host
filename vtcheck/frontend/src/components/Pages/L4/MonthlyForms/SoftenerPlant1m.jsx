...
const SoftenerPlant1m = () => {
  ...
  const dropdownLabels = [  'Use LOTO before start start of the work at incomer supply (Acceptance Criteria - Lock out with life tag)',
    'Clean the unit (With Cotton) (Acceptance Criteria - Clean)',
    'Check & tight all the bolts & joints (Acceptance Criteria - Tighten)',
    'Clean the sand filter (Acceptance Criteria - Clean)',
    'Clean the carbon filter (Acceptance Criteria - Clean)',
    'Check all pumps (Acceptance Criteria - Working)',
    'Check Emergency switch working (Acceptance Criteria - Done )',
    'Trial the unit (Acceptance Criteria - Done)',
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/softener_plant_1_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/softener_plant_1_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Softener Plant</h1>
...
export default SoftenerPlant1m;