...
const FireWaterLine3m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/fire_water_line_3_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/fire_water_line_3_m', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Fire Water Line - 3</h1>
      <h1 className='text-xl font-semibold text-center'>EQUIPMENT NAME : Fire water line (Inhouse- Mechanical  area)</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(EQUIPMENT NO: VT/FM/UTM/MECHAA/FIRELINE/6220)</h1>
      <hr /><hr /><br /><br />
...
export default FireWaterLine3m;