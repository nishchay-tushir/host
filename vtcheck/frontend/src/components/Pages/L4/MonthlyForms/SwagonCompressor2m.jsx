...
const SwagonCompressor2m = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/swagon_compressor_2_m/status')
      .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/swagon_compressor_2_m', formData)
      .then(response => {
...
export default SwagonCompressor2m;