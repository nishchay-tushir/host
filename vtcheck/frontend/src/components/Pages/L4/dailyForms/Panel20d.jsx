...
const Panel20d = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/panel_20_d/status')
      .then(response => {
    ...
    const timer = setTimeout(() => {
      if (submittedToday !== 'Filled for today') {
        ...
        axios.post('https://scheq.in/api/panel_20_d', autoFormData)
          .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/panel_20_d', formData)
      .then(response => {
