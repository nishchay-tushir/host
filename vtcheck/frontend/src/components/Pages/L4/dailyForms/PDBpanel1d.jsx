...
const PDBpanel1d = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/pdb_panel_1_d/status')
      .then(response => {
    ...
    const timer = setTimeout(() => {
      if (submittedToday !== 'Filled for today') {
        ...
        axios.post('https://scheq.in/api/pdb_panel_1_d', autoFormData)
          .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/pdb_panel_1_d', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-xl font-semibold text-center'>Equipment Name: Panel- 30 (BMS PDB)</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(Equipment no: VVT/FM/UTM/BMSPDBPanel/141)</h1>
      <hr /><hr /><br /><br />
