...
const HTLTpanel8d = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/ht_lt_panel_8_d/status')
      .then(response => {
    ...
    const timer = setTimeout(() => {
      if (submittedToday !== 'Filled for today') {
        ...
        axios.post('https://scheq.in/api/ht_lt_panel_8_d', autoFormData)
          .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/ht_lt_panel_8_d', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>HT & LT Panel - 8</h1>
      <h1 className='text-xl font-semibold text-center'>Equipment Name: 22KV Outgoing Indoor VCB HT Panel</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(Equipment no: VT/FM/UTM/HTP/OG/008)</h1>
      <hr /><hr /><br /><br />
