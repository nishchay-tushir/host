...
const RapidRollingShutter1d = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/rapid_rolling_shutter_1_d/status')
      .then(response => {
    ...
    const timer = setTimeout(() => {
      if (submittedToday !== 'Filled for today') {
        ...
        axios.post('https://scheq.in/api/rapid_rolling_shutter_1_d', autoFormData)
          .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/rapid_rolling_shutter_1_d', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Rapid Rolling Shutter</h1>
      <h1 className='text-xl font-semibold text-center'>Equipment Name: Rapid Rolling Shutter</h1>
        ...
        <>
          ...
          <h1 className='text-2xl font-semibold mb-6 text-center'>Visual Inspection</h1><br />
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                ...
                <div className='flex flex-col'>
                <label className='text-md font-medium mb-1'>Check for all push buttons<br /><span className='text-sm'>(Acceptance Criteria - OK)</span></label>
                ...
                <div className='flex flex-col'>
                <label className='text-md font-medium mb-1'>Check sensor cell<br /><span className='text-sm'>(Acceptance Criteria - OK)</span></label>
                <select name='sensorCell' value={formData.sensorCell || ''} onChange={handleChange} className='p-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500'>
                    <option value="" disabled>Select</option>
                    <option value="OK">OK</option>
                    <option value="NOK">NOK</option>
                </select>
                ...
                <div className='flex flex-col'>
                <label className='text-md font-medium mb-1'>Check drive box<br /><span className='text-sm'>(Acceptance Criteria - OK)</span></label>
                <select name='driveBox' value={formData.driveBox || ''} onChange={handleChange} className='p-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500'>
                    <option value="" disabled>Select</option>
                    <option value="OK">OK</option>
                    <option value="NOK">NOK</option>
                </select>
...
export default RapidRollingShutter1d;
