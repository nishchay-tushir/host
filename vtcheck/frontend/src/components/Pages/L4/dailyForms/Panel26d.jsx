...
const Panel26d = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/panel_26_d/status')
      .then(response => {
    ...
    const timer = setTimeout(() => {
      if (submittedToday !== 'Filled for today') {
        ...
        axios.post('https://scheq.in/api/panel_26_d', autoFormData)
          .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/panel_26_d', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Panel - 26</h1>
      <h1 className='text-xl font-semibold text-center'>Equipment Name: Panel-26 (UPS Outgoing)</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(Equipment no: VT/FM/UTM/UPSOGPanel/137)</h1>
      <hr /><hr /><br /><br />
