...
const Panel22d = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/panel_22_d/status')
      .then(response => {
    ...
    const timer = setTimeout(() => {
      if (submittedToday !== 'Filled for today') {
        ...
        axios.post('https://scheq.in/api/panel_22_d', autoFormData)
          .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/panel_22_d', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Panel - 22</h1>
      <h1 className='text-xl font-semibold text-center'>Equipment Name: Panel-22 (L2 AHU No. 103)</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(Equipment no: VT/FM/UTM/L2AHU103Panel/133)</h1>
      <hr /><hr /><br /><br />
