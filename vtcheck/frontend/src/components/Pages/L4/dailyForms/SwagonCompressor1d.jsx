...
const SwagonCompressor1d = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/swagon_compressor_1_d/status')
      .then(response => {
    ...
    const timer = setTimeout(() => {
      if (submittedToday !== 'Filled for today') {
        ...
        axios.post('https://scheq.in/api/swagon_compressor_1_d', autoFormData)
          .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/swagon_compressor_1_d', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Swagon Compressor - 1</h1>
...
export default SwagonCompressor1d;
