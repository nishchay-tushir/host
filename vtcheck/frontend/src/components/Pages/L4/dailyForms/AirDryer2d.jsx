...
const AirDryer2d = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/air_dryer_2_d/status')
      .then(response => {
    ...
    const timer = setTimeout(() => {
      if (submittedToday !== 'Filled for today') {
        ...
        axios.post('https://scheq.in/api/air_dryer_2_d', autoFormData)
          .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/air_dryer_2_d', formData)
      .then(response => {
