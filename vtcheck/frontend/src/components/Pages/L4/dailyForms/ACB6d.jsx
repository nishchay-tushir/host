...
const ACB6d = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/acb_6_d/status')
      .then(response => {
    ...
    const timer = setTimeout(() => {
      if (submittedToday !== 'Filled for today') {
        ...
        axios.post('https://scheq.in/api/acb_6_d', autoFormData)
          .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/acb_6_d', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>ACB - 6</h1>
      <h1 className='text-xl font-semibold text-center'>Equipment Name:Air  circuit breaker (L&T) (587 KW Chiller -02)</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(Equipment no: VT/FM/UTM/ACB/022)</h1>
      <hr /><hr /><br /><br />
