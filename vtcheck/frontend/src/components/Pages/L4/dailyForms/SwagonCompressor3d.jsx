...
const SwagonCompressor3d = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://scheq.in/api/swagon_compressor_3_d/status')
      .then(response => {
    ...
    const timer = setTimeout(() => {
      if (submittedToday !== 'Filled for today') {
        ...
        axios.post('https://scheq.in/api/swagon_compressor_3_d', autoFormData)
          .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://scheq.in/api/swagon_compressor_3_d', formData)
      .then(response => {
  ...
  return (
    <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
      ...
      <h1 className='text-4xl font-semibold mb-6 text-center'>Swagon Compressor Admin Office - 1</h1>
      <h1 className='text-xl font-semibold text-center'>Equipment Name: Swagon compressor-1- Admin office. Sr. No. SB10068069</h1>
      <h1 className='text-xl font-semibold mb-6 text-center'>(Equipment no: VT/FM/UTM/ADOFF/SWAGCOMP1/6080)</h1>
      <hr /><hr /><br /><br />
...
export default SwagonCompressor3d;
