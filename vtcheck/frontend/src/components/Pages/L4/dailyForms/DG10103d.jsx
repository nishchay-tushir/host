...
const DG10103d = () => {
    const [formData, setFormData] = useState({
      ...
      const inputLabels = [
        'Check Diesel Level (Liters)', 'Check the  Avg. voltage of Alternator', 'Check the Avg. Amps of Alternator', 'Check Kilowatt Hours (KWH)', 'Check the power of alternator (KW)',
        'Check the Power factor of DG (PF)', 'Check the Frequency of alternator ', 'Check the Running time of Engine (Hours)', 'Check the coolant temperature (⁰C)',
        'Check the oil Temperature (⁰C)', 'Check for the PCC battery voltage (V)', 'Check the Torque in %', 'Check the RPM of Engine (Rated= 1500) ', 'Check and record the Fault history'
      ];
    
      useEffect(() => {
        // Fetch submission status for today
        axios.get('https://scheq.in/api/dg_1010_3_d/status')
          .then(response => {
        ...
        const timer = setTimeout(() => {
          if (submittedToday !== 'Filled for today') {
            ...
            axios.post('https://scheq.in/api/dg_1010_3_d', autoFormData)
              .then(response => {
      ...
      const handleSubmit = (e) => {
        ...
        axios.post('https://scheq.in/api/dg_1010_3_d', formData)
          .then(response => {
      ...
      return (
        <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
          ...
          <h1 className='text-4xl font-semibold mb-6 text-center'>DG-1010 - 3</h1>
