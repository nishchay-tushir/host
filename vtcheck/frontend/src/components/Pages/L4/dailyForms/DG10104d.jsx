...
const DG10104d = () => {
    const [formData, setFormData] = useState({
      ...
      useEffect(() => {
        ...
        axios.get('https://scheq.in/api/dg_1010_4_d/status')
          .then(response => {
        ...
        const timer = setTimeout(() => {
          if (submittedToday !== 'Filled for today') {
            ...
            axios.post('https://scheq.in/api/dg_1010_4_d', autoFormData)
              .then(response => {
      ...
      const handleSubmit = (e) => {
        ...
        axios.post('https://scheq.in/api/dg_1010_4_d', formData)
          .then(response => {
      ...
      return (
        <div className='p-6 max-w-4xl mx-auto bg-white shadow-md rounded-lg my-6'>
          ...
          <h1 className='text-4xl font-semibold mb-6 text-center'>DG-1010 - 4</h1>
          <h1 className='text-xl font-semibold text-center'>Equipment Name: D.G.-4- 1010 KVA ESN NO.- 25366157</h1>
          <h1 className='text-xl font-semibold mb-6 text-center'>(Equipment VT/FM/UTM/DG-4/1010KVA/6191)</h1>
          <hr /><hr /><br /><br />
