...
const BreakdownDash = () => {
  ...
  const toggleDailyDropdown = (e) => {
    e.preventDefault();
    navigate('/dg_1010_4_d_dashboard');
  };
...
const exportToCSV = () => {
    ...
    a.setAttribute('download', 'dg_1010_4_daily_checksheet_data.csv');
    a.click();
  ...
  return (
    ...
    <>
        <div className='flex m-2 fixed'>
            ...
            <div className='flex w-full text-center m-4 bg-gray-900 z-50 rounded-xl shadow-lg shadow-gray-700 ml-6 overflow-hidden'>
                <div className='w-full'>
                    <h1 className='text-2xl mt-2 font-extrabold text-gray-200'>DG-1010 - 4 Dashboard VT1014532-F10</h1>
                </div>
            </div>
        </div>
        <br /><br /><br /><br />
        <div className='bg-gray-900 w-fit m-3 rounded-xl z-50 p-2 shadow-lg shadow-gray-700 text-white overflow-hidden fixed'>
            ...
            <h1 onClick={toggleDailyDropdown} className='p-2 cursor-pointer shadow-md rounded-lg my-1 bg-green-700'>Daily Breakdowns</h1>
            <h1 onClick={toggleDailyDropdown} className='p-2 cursor-pointer shadow-md rounded-lg my-1 bg-green-700'>Monthly Breakdowns</h1>
            <h1 onClick={toggleDailyDropdown} className='p-2 cursor-pointer shadow-md rounded-lg my-1 bg-green-700'>Quarterly Breakdowns</h1>
            ...
            <>
                ...
                <h1 className="text-2xl text-center font-bold mb-4">DG-1010 - 4 Daily Dashboard</h1>
                ...
                <div>
                    ...
                    <div className="ml-56">
                        {[
                            ...
                            { inputData: 'input6', label: 'Power Factor of DG (PF)', backgroundColor: 'black' },
                            ...
                            { inputData: 'input11', label: 'PCC Battery Voltage (V)', backgroundColor: 'yellowgreen' },
                            { inputData: 'input12', label: 'Torque (%)', backgroundColor: 'yellowgreen' },
                            { inputData: 'input13', label: 'RPM of Engine', backgroundColor: 'yellowgreen' },
                            { inputData: 'input14', label: 'Fault History', backgroundColor: 'yellowgreen' },
                        ].map((chart, index) => {
