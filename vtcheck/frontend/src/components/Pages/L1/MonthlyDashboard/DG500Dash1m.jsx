...
const DG500Dash1m = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://scheq.in/api/dg_500_1_m")
      .then((response) => {
  ...
  const exportToCSV = () => {
    ...
    'Check Neutral and earthing of DG electrical panel(Multimeter)',
    'Check for battery terminal voltage with multimeter (Should not excess than 13.5 V)',
    'Check the RPM of Engine(Taco meter) ',
    ...
    a.setAttribute('download', 'dg_500_1_monthly_checksheet_data.csv');
    a.click();
    ...
    <>
        <div className='flex m-2 fixed'>
            ...
            <div className='flex w-full text-center m-4 bg-gray-900 z-50 rounded-xl shadow-lg shadow-gray-700 ml-6 overflow-hidden'>
                <div className='w-full'>
                    <h1 className='text-2xl my-4 font-extrabold text-gray-200'>DG - 500 - 1 Dashboard VT1014532-F10</h1>
                </div>
            </div>
        </div>
        <br /><br /><br /><br />
        <div className='bg-gray-900 w-fit m-3 rounded-xl z-50 p-2 shadow-lg shadow-gray-700 text-white overflow-hidden fixed'>
            ...
            <>
                ...
                <h1 className="text-2xl text-center font-bold mb-4">DG - 500 - 1 Monthly Dashboard</h1>
                  ...
                  <h1 className="font-semibold text-xl text-center mb-2">Data Chart</h1><br />
                    <div className="overflow-y-auto overflow-x-auto max-h-96">
                        ...
                        <thead className="bg-gray-200 sticky top-0">
                            ...
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold min-w-40">Check DG is in Auto or in Manual mode (Acceptance Criteria - Observation(Auto))</th>
                            ...
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold min-w-40">Check the coolent level  (Acceptance Criteria - Maximum)</th>
                            ...
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold min-w-40">Inspect if any abnormal vibration and noise in DG  (Acceptance Criteria - No vibration )</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold min-w-40">Check for oil levals - Once in a day (Acceptance Criteria - Maximum)</th>
                            ...
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold min-w-40">Check Neutral and earthing of DG electrical panel(Multimeter)</th>
                            ...
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold min-w-40">Check the RPM of Engine(Taco meter) </th>
