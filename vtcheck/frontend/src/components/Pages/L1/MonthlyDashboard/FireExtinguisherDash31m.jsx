...
const FireExtinguisherDash31m = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://scheq.in/api/fire_extinguisher_31_m")
      .then((response) => {
  ...
  const exportToCSV = () => {
    ...
    a.setAttribute('download', 'fire_extinguisher_31_monthly_checksheet_data.csv');
    a.click();
    ...
    <>
        <div className='flex m-2 fixed'>
            ...
            <div className='flex w-full text-center m-4 bg-gray-900 z-50 rounded-xl shadow-lg shadow-gray-700 ml-6 overflow-hidden'>
                <div className='w-full'>
                    <h1 className='text-2xl my-4 font-extrabold text-gray-200'>Fire Extinguisher - 31 Dashboard VT1014532-F10</h1>
                </div>
            </div>
        </div>
        <br /><br /><br /><br />
        <div className='bg-gray-900 w-fit m-3 rounded-xl z-50 p-2 shadow-lg shadow-gray-700 text-white overflow-hidden fixed'>
            ...
            <>
                ...
                <h1 className="text-2xl text-center font-bold mb-4">Fire Extinguisher - 31 Monthly Dashboard</h1>
...
export default FireExtinguisherDash31m;
