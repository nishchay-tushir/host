...
const CoolingTowerDash1d = () => {
  ...
  const toggleDailyDropdown = (e) => {
    e.preventDefault();
    navigate('/cooling_tower_1_d_dashboard');
  };

  const toggleMonthlyDropdown = (e) => {
    e.preventDefault();
    navigate('/cooling_tower_1_m_dashboard');
  };

  const toggleQuarterlyDropdown = (e) => {
    e.preventDefault();
    navigate('/cooling_tower_1_q_dashboard');
  };

  const toggleTimeBasedDropdown = (e) => {
    e.preventDefault();
    navigate('/cooling_tower_1_tb_dashboard');
  }
  ...
  useEffect(() => {
    ...
    axios
      .get("https://scheq.in/api/cooling_tower_1_d")
      .then((response) => {
  ...
  const exportToCSV = () => {
    ...
    const headers = [
        ...
        'Operating Oil Level',
        'Water Level of the Cooling in Sump',
        'Any Leakage of Water',
        'Pressurise Unit',
        'Working of All Pumps',
    ...
    a.setAttribute('download', 'cooling_tower_1_daily_checksheet_data.csv');
    a.click();
    ...
    <>
        <div className='flex m-2 fixed'>
            ...
            <div className='flex w-full text-center m-4 bg-gray-900 z-50 rounded-xl shadow-lg shadow-gray-700 ml-6 overflow-hidden'>
                <div className='w-full'>
                    <h1 className='text-2xl mt-2 font-extrabold text-gray-200'>Cooling Tower - 1 Dashboard VT1014532-F10</h1>
                </div>
            </div>
        </div>
        <br /><br /><br /><br />
        <div className='bg-gray-900 w-fit m-3 rounded-xl z-50 p-2 shadow-lg shadow-gray-700 text-white overflow-hidden fixed'>
            ...
            <>
                ...
                <h1 className="text-2xl text-center font-bold mb-4">Cooling Tower - 1 Daily Dashboard</h1>
                {data.slice(0, 1).map((item) => (
                    <div key={item._id} className="p-4 border rounded shadow">
                        ...
                        <div className="grid grid-cols-4 gap-y-12 gap-x-4">
                          ...
                          <div className="shadow-md p-2 bg-white rounded-sm">
                              <Pie data={getPieData("Operating Oil Level", "OilLevel")} />
                              <p className="text-center mt-2">Operating Oil Level</p>
                          </div>
                          <div className="shadow-md p-2 bg-white rounded-sm">
                              <Pie data={getPieData("Water Level of the Cooling in Sump", "WaterLevel")} />
                              <p className="text-center mt-2">Water Level of the Cooling in Sump</p>
                          </div>
                          <div className="shadow-md p-2 bg-white rounded-sm">
                              <Pie data={getPieData("Any Leakage of Water", "WaterLeakage")} />
                              <p className="text-center mt-2">Any Leakage of Water</p>
                          </div>
                          <div className="shadow-md p-2 bg-white rounded-sm">
                              <Pie data={getPieData("Pressurise Unit", "PressuriseUnit")} />
                              <p className="text-center mt-2">Pressurise Unit</p>
                          </div>
                          <div className="shadow-md p-2 bg-white rounded-sm">
                              <Pie data={getPieData("Working of All Pumps", "Pumps")} />
                              <p className="text-center mt-2">Working of All Pumps</p>
                          </div>
                          <div className="shadow-md p-2 bg-white rounded-sm">
                              <Pie data={getPieData("Water Pipe Line Leakage", "PipeLeaks")} />
                              <p className="text-center mt-2">Water Pipe Line Leakage</p>
                          </div>
                          <div className="shadow-md p-2 bg-white rounded-sm">
                              <Pie data={getPieData("Abnormal Noise or Vibrations", "VibrationsNoises")} />
                              <p className="text-center mt-2">Abnormal Noise or Vibrations</p>
                          </div>
                        </div>
                    </div>
                    ))}
                  ...
                  <h1 className="font-semibold text-xl text-center mb-2">Data Chart</h1><br />
                    <div className="overflow-y-auto overflow-x-auto max-h-96">
                        ...
                        <thead className="bg-gray-200 sticky top-0">
                            ...
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Operating Oil Level</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Water Level of the Cooling in Sump</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Any Leakage of Water</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Pressurise Unit</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Working of All Pumps</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Water Pipe Line Leakage</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Abnormal Noise or Vibrations</th>
                        ...
                        <tbody>
                            ...
                            <tr key={item._id} className="hover:bg-gray-100">
                                ...
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.WaterLevel}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.WaterLeakage}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.PressuriseUnit}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.Pumps}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.PipeLeaks}</td>
...
export default CoolingTowerDash1d;
