...
const DG500Dash3d = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://scheq.in/api/dg_500_3_d")
      .then((response) => {
...
const exportToCSV = () => {
    ...
    a.setAttribute('download', 'dg_500_3_daily_checksheet_data.csv');
    a.click();
    ...
    <>
        <div className='flex m-2 fixed'>
            ...
            <div className='flex w-full text-center m-4 bg-gray-900 z-50 rounded-xl shadow-lg shadow-gray-700 ml-6 overflow-hidden'>
                <div className='w-full'>
                    <h1 className='text-2xl mt-2 font-extrabold text-gray-200'>DG-500 - 3 Dashboard VT1014532-F10</h1>
                </div>
            </div>
        </div>
        <br /><br /><br /><br />
        <div className='bg-gray-900 w-fit m-3 rounded-xl z-50 p-2 shadow-lg shadow-gray-700 text-white overflow-hidden fixed'>
            ...
            <>
                ...
                <h1 className="text-2xl text-center font-bold mb-4">DG-500 - 3 Daily Dashboard</h1>
                ...
                <div>
                    ...
                    <div className="ml-56">
                        {[
                            ...
                            { inputData: 'input2', label: 'Engine Speed', backgroundColor: 'crimson' },
                            { inputData: 'input3', label: 'Lube Oil Pressure', backgroundColor: 'darkgreen' },
                            { inputData: 'input4', label: 'Coolant Temperature (°C)', backgroundColor: 'orange' },
                            { inputData: 'input5', label: 'Intake Air Temperature', backgroundColor: 'gray' },
                            { inputData: 'input6', label: 'Engine run time (Hour)', backgroundColor: 'black' },
                            { inputData: 'input7', label: 'Battery (V)', backgroundColor: 'purple' },
                            { inputData: 'input8', label: 'Actuator command (%)', backgroundColor: 'darkorange' },
                            { inputData: 'input9', label: 'ECP fault code', backgroundColor: 'violet' },
                            { inputData: 'input10', label: 'Fault History', backgroundColor: 'yellowgreen' },
                        ].map((chart, index) => {
