...
const AirReservoirTankDash1d = () => {
  ...
  const toggleDailyDropdown = (e) => {
    e.preventDefault();
    navigate('/air_reservoir_tank_1_d_dashboard');
  };

  const toggleMonthlyDropdown = (e) => {
    e.preventDefault();
    navigate('/air_reservoir_tank_1_m_dashboard');
  };

  const toggleQuarterlyDropdown = (e) => {
    e.preventDefault();
    navigate('/air_reservoir_tank_1_q_dashboard');
  };

  const toggleTimeBasedDropdown = (e) => {
    e.preventDefault();
    navigate('/air_reservoir_tank_1_tb_dashboard');
  }
  ...
  useEffect(() => {
    ...
    axios
      .get("https://scheq.in/api/air_reservoir_tank_1_d")
      .then((response) => {
  ...
  const exportToCSV = () => {
    ...
    const headers = [
        ...
        'Air Inlet Valve Condition',
        'Air Outlet Valve Condition',
        'Air Leakage in Tank or Line',
        'Water Drain Valve Opened for 2 min',
        'Remarks',
    ];
    ...
    a.setAttribute('download', 'air_reservoir_tank_1_daily_checksheet_data.csv');
    a.click();
    ...
    <>
        <div className='flex m-2 fixed'>
            ...
            <div className='flex w-full text-center m-4 bg-gray-900 z-50 rounded-xl shadow-lg shadow-gray-700 ml-6 overflow-hidden'>
                <div className='w-full'>
                    <h1 className='text-2xl mt-2 font-extrabold text-gray-200'>Air Reservoir Tank - 1 Dashboard VT1014532-F10</h1>
                </div>
            </div>
        </div>
        <br /><br /><br /><br />
        <div className='bg-gray-900 w-fit m-3 rounded-xl z-50 p-2 shadow-lg shadow-gray-700 text-white overflow-hidden fixed'>
            ...
            <>
                ...
                <h1 className="text-2xl text-center font-bold mb-4">Air Reservoir Tank - 1 Daily Dashboard</h1>
                    ...
                    <div key={item._id} className="p-4 border rounded shadow">
                        ...
                        <div className="grid grid-cols-4 gap-y-12 gap-x-4">
                          <div className="shadow-md p-2 bg-white rounded-sm">
                              <Pie data={getPieData("Air Pressure (kg/cm^2)", "AirPressure")} />
                              <p className="text-center mt-2">Air Pressure (kg/cm^2)</p>
                          </div>
                          <div className="shadow-md p-2 bg-white rounded-sm">
                              <Pie data={getPieData("Air Inlet Valve Condition", "AirInlet")} />
                              <p className="text-center mt-2">Air Inlet Valve Condition</p>
                          </div>
                          <div className="shadow-md p-2 bg-white rounded-sm">
                              <Pie data={getPieData("Air Outlet Valve Condition", "AirOutlet")} />
                              <p className="text-center mt-2">Air Outlet Valve Condition</p>
                          </div>
                          <div className="shadow-md p-2 bg-white rounded-sm">
                              <Pie data={getPieData("Air Leakage in Tank or Line", "AirLeakage")} />
                              <p className="text-center mt-2">Air Leakage in Tank or Line</p>
                          </div>
                          <div className="shadow-md p-2 bg-white rounded-sm">
                              <Pie data={getPieData("Water Drain Valve Opened for 2 min", "WaterDrain")} />
                              <p className="text-center mt-2">Water Drain Valve Opened for 2 min</p>
                          </div>
                        </div>
                    </div>
                    ))}
                  ...
                  <h1 className="font-semibold text-xl text-center mb-2">Data Chart</h1><br />
                    <div className="overflow-y-auto overflow-x-auto max-h-96">
                        ...
                        <thead className="bg-gray-200 sticky top-0">
                            ...
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Air Pressure (kg/cm^2)</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Air Inlet Valve Condition</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Air Outlet Valve Condition</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Air Leakage in Tank or Line</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Water Drain Valve Opened for 2 min</th>
                        ...
                        <tbody>
                            ...
                            <tr key={item._id} className="hover:bg-gray-100">
                                ...
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.AirPressure}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.AirInlet}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.AirOutlet}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.AirLeakage}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.WaterDrain}</td>
...
export default AirReservoirTankDash1d;
