...
const AirDryerDash1d = () => {
  ...
  const toggleDailyDropdown = (e) => {
    e.preventDefault();
    navigate('/air_dryer_1_d_dashboard');
  };

  const toggleMonthlyDropdown = (e) => {
    e.preventDefault();
    navigate('/air_dryer_1_m_dashboard');
  };

  const toggleQuarterlyDropdown = (e) => {
    e.preventDefault();
    navigate('/air_dryer_1_q_dashboard');
  };

  const toggleTimeBasedDropdown = (e) => {
    e.preventDefault();
    navigate('/air_dryer_1_tb_dashboard');
  }
  ...
  useEffect(() => {
    ...
    axios
      .get("https://scheq.in/api/air_dryer_1_d")
      .then((response) => {
...
const exportToCSV = () => {
    ...
    const headers = [
        ...
        'Dryer Switch on Main Panel',
        'Dryer Switch on Sub Panel',
        'Inlet Valve Condition',
        'Outlet Valve Condition',
        'Run Enable Valve',
        'Flow Switch',
        'Dryer Running Status',
        'Leakage Found',
        ...
        'Dryer PDP from Display',
        'Relative Humidity',
        'Running Hours',
        'EEV 1 (% Opened)',
        'EEV 2 (% Opened)',
        'Electronic HGBP Valve 1',
        'Electronic HGBP Valve 2',
        'Calculated Power from Display',
        'Remarks',
    ];
    ...
    a.setAttribute('download', 'air_dryer_1_daily_checksheet_data.csv');
    a.click();
    ...
    <>
        <div className='flex m-2 fixed'>
            ...
            <div className='flex w-full text-center m-4 bg-gray-900 z-50 rounded-xl shadow-lg shadow-gray-700 ml-6 overflow-hidden'>
                <div className='w-full'>
                    <h1 className='text-2xl mt-2 font-extrabold text-gray-200'>Air Dryer - 1 Dashboard VT1014532-F10</h1>
                </div>
            </div>
        </div>
        <br /><br /><br /><br />
        <div className='bg-gray-900 w-fit m-3 rounded-xl z-50 p-2 shadow-lg shadow-gray-700 text-white overflow-hidden fixed'>
            ...
            <>
                ...
                <h1 className="text-2xl text-center font-bold mb-4">Air Dryer - 1 Daily Dashboard</h1>
                    ...
                    <div key={item._id} className="p-4 border rounded shadow-md">
                        ...
                        <div className="grid grid-cols-4 gap-y-12 gap-x-4">
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Main Electrical Panel", "dropdown1")} /> 
                                <p className="text-center mt-2">Main Electrical Panel</p>
                            </div>
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Dryer Switch on Main Panel", "dropdown2")} /> 
                                <p className="text-center mt-2">Dryer Switch on Main Panel</p>
                            </div>
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Dryer Switch on Sub Panel", "dropdown3")} /> 
                                <p className="text-center mt-2">Dryer Switch on Sub Panel</p>
                            </div>
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Inlet Valve Condition", "dropdown4")} /> 
                                <p className="text-center mt-2">Inlet Valve Condition</p>
                            </div>
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Outlet Valve Condition", "dropdown5")} /> 
                                <p className="text-center mt-2">Outlet Valve Condition</p>
                            </div>
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Run Enable Valve", "dropdown6")} /> 
                                <p className="text-center mt-2">Run Enable Valve</p>
                            </div>
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Flow Switch", "dropdown7")} /> 
                                <p className="text-center mt-2">Flow Switch</p>
                            </div>
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Dryer Running Status", "dropdown8")} /> 
                                <p className="text-center mt-2">Dryer Running Status</p>
                            </div>
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Leakage Found", "Leakage")} /> 
                                <p className="text-center mt-2">Leakage Found</p>
                            </div>
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Auto Drain Valve Working", "DrainValve")} /> 
                                <p className="text-center mt-2">Auto Drain Valve Working</p>
                            </div>
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Abnormal Sound", "AbnormalNoise")} /> 
                                <p className="text-center mt-2">Abnormal Sound</p>
                            </div>
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Fuse Condition", "FuseCondition")} /> 
                                <p className="text-center mt-2">Fuse Condition</p>
                            </div>
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Machine Cleanliness", "Cleanliness")} /> 
                                <p className="text-center mt-2">Machine Cleanliness</p>
                            </div>
                            <div className="shadow-md p-2 bg-white rounded-sm">
                ...
                <div>
                    ...
                    <div className="ml-56">
                        {[ 
                            { inputData: 'input1', label: 'Dryer PDP from Display', backgroundColor: 'darkblue' },
                            { inputData: 'input2', label: 'Relative Humidity', backgroundColor: 'darkgreen' },
                            { inputData: 'input3', label: 'Running Hours', backgroundColor: 'darkred' },
                            { inputData: 'input4', label: 'EEV 1 (% Opened)', backgroundColor: 'darkorange' },
                            { inputData: 'input5', label: 'EEV 2 (% Opened)', backgroundColor: 'darkpurple' },
                            { inputData: 'input6', label: 'Electronic HGBP Valve 1', backgroundColor: 'darkcyan' },
                            { inputData: 'input7', label: 'Electronic HGBP Valve 2', backgroundColor: 'darkmagenta' },
                            { inputData: 'input8', label: 'Calculated Power from Display', backgroundColor: 'crimson' }
                        ].map((chart, index) => {
                  ...
                  <h1 className="font-semibold text-xl text-center mb-2">Data Chart</h1><br />
                    <div className="overflow-y-auto overflow-x-auto max-h-96">
                        ...
                        <thead className="bg-gray-200 sticky top-0">
                            ...
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Main Electrical Panel</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Dryer Switch on Main Panel</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Dryer Switch on Sub Panel</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Inlet Valve Condition</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Outlet Valve Condition</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Run Enable Valve</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Flow Switch</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Dryer Running Status</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Leakage Found</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Auto Drain Valve Working</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Abnormal Sound</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Fuse Condition</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Machine Cleanliness</th>
                            ...
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Dryer PDP from Display</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Relative Humidity</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Running Hours</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">EEV 1 (% Opened)</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">EEV 2 (% Opened)</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Electronic HGBP Valve 1</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Electronic HGBP Valve 2</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Calculated Power from Display</th>
                        ...
                        <tbody>
                            ...
                            <tr key={item._id} className="hover:bg-gray-100">
                                ...
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.DrainValve}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.AbnormalNoise}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.FuseCondition}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.Cleanliness}</td>
