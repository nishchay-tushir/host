...
const ELDBPanelDash1d = () => {
  ...
  const toggleDailyDropdown = (e) => {
    e.preventDefault();
    navigate('/eldb_panel_1_d_dashboard');
  };

  const toggleMonthlyDropdown = (e) => {
    e.preventDefault();
    navigate('/eldb_panel_1_m_dashboard');
  };

  const toggleQuarterlyDropdown = (e) => {
    e.preventDefault();
    navigate('/eldb_panel_1_q_dashboard');
  };

  const toggleTimeBasedDropdown = (e) => {
    e.preventDefault();
    navigate('/eldb_panel_1_tb_dashboard');
  }
  ...
  useEffect(() => {
    ...
    axios
      .get("https://scheq.in/api/eldb_panel_1_d")
      .then((response) => {
  ...
  const exportToCSV = () => {
    ...
    a.setAttribute('download', 'eldb_panel_1_daily_checksheet_data.csv');
    a.click();
    ...
    <>
        <div className='flex m-2 fixed'>
            ...
            <div className='flex w-full text-center m-4 bg-gray-900 z-50 rounded-xl shadow-lg shadow-gray-700 ml-6 overflow-hidden'>
                <div className='w-full'>
                    <h1 className='text-2xl mt-2 font-extrabold text-gray-200'>ELDB Panel - 1 Dashboard VT1014532-F10</h1>
                </div>
            </div>
        </div>
        <br /><br /><br /><br />
        <div className='bg-gray-900 w-fit m-3 rounded-xl z-50 p-2 shadow-lg shadow-gray-700 text-white overflow-hidden fixed'>
            ...
            <>
                ...
                <h1 className="text-2xl text-center font-bold mb-4">ELDB Panel - 1 Daily Dashboard</h1>
                    ...
                    <div key={item._id} className="p-4 border rounded shadow">
                        ...
                        <div className="grid grid-cols-4 gap-y-12 gap-x-4">
                          <div className="shadow-md p-2 bg-white rounded-sm">
                              <Pie data={getPieData("All MCB condition", "mcbCondition")} />
                              <p className="text-center mt-2">All MCB condition</p>
                          </div>

                          <div className="shadow-md p-2 bg-white rounded-sm">
                              <Pie data={getPieData("MCCB condition", "mccbCondition")} />
                              <p className="text-center mt-2">MCCB condition</p>
                          </div>

                          <div className="shadow-md p-2 bg-white rounded-sm">
                              <Pie data={getPieData("RCCB condition", "rccbCondition")} />
                              <p className="text-center mt-2">RCCB condition</p>
                          </div>

                          <div className="shadow-md p-2 bg-white rounded-sm">
                              <Pie data={getPieData("Earthing", "earthingCheck")} />
                              <p className="text-center mt-2">Earthing</p>
                          </div>

                          <div className="shadow-md p-2 bg-white rounded-sm">
                              <Pie data={getPieData("Wire Burning Smell", "wireBurningSmell")} />
                              <p className="text-center mt-2">Wire Burning Smell</p>
                          </div>
                  ...
                  <h1 className="font-semibold text-xl text-center mb-2">Data Chart</h1><br />
                    <div className="overflow-y-auto overflow-x-auto max-h-96">
                        ...
                        <thead className="bg-gray-200 sticky top-0">
                            ...
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">All MCB condition</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">MCCB condition</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">RCCB condition</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Earthing</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Wire Burning Smell</th>
                        ...
                        <tbody>
                            ...
                            <tr key={item._id} className="hover:bg-gray-100">
                                ...
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.mcbCondition}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.mccbCondition}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.rccbCondition}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.earthingCheck}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.wireBurningSmell}</td>
...
export default ELDBPanelDash1d;
