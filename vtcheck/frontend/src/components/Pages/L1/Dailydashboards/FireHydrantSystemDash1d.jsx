...
const FireHydrantSystemDash1d = () => {
  ...
  const toggleDailyDropdown = (e) => {
    e.preventDefault();
    navigate('/fire_hydrant_system_1_d_dashboard');
  };

  const toggleMonthlyDropdown = (e) => {
    e.preventDefault();
    navigate('/fire_hydrant_system_1_m_dashboard');
  };

  const toggleQuarterlyDropdown = (e) => {
    e.preventDefault();
    navigate('/fire_hydrant_system_1_q_dashboard');
  };

  const toggleTimeBasedDropdown = (e) => {
    e.preventDefault();
    navigate('/fire_hydrant_system_1_tb_dashboard');
  }
  ...
  useEffect(() => {
    ...
    axios
      .get("https://scheq.in/api/fire_hydrant_system_1_d")
      .then((response) => {
  ...
  const exportToCSV = () => {
    ...
    dateRange.forEach(date => {
        if (submissionDates.has(date)) {
            ...
            const row = [
                ...
                item.valveCondition,
                item.wheelCondition,
                item.hoseClampCondition,
                item.nozzleCondition,
                item.unitCleanliness,
                item.remarks,
            ];
    ...
    a.setAttribute('download', 'fire_hydrant_system_1_daily_checksheet_data.csv');
    a.click();
    ...
    <>
        <div className='flex m-2 fixed'>
            ...
            <div className='flex w-full text-center m-4 bg-gray-900 z-50 rounded-xl shadow-lg shadow-gray-700 ml-6 overflow-hidden'>
                <div className='w-full'>
                    <h1 className='text-2xl mt-2 font-extrabold text-gray-200'>Fire Hydrant System - 1 Dashboard VT1014532-F10</h1>
                </div>
            </div>
        </div>
        <br /><br /><br /><br />
        <div className='bg-gray-900 w-fit m-3 rounded-xl z-50 p-2 shadow-lg shadow-gray-700 text-white overflow-hidden fixed'>
            ...
            <>
                ...
                <h1 className="text-2xl text-center font-bold mb-4">Fire Hydrant System - 1 Daily Dashboard</h1>
                    ...
                    <div key={item._id} className="p-4 border rounded shadow">
                        ...
                        <div className="grid grid-cols-4 gap-y-12 gap-x-4">
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Damage Check", "damageCheck")} />
                                <p className="text-center mt-2">Damage Check</p>
                            </div>
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Bolt Condition", "boltTightening")} />
                                <p className="text-center mt-2">Bolt Condition</p>
                            </div>
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Valve Condition", "valveCondition")} />
                                <p className="text-center mt-2">Valve Condition</p>
                            </div>
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Wheel Condition", "wheelCondition")} />
                                <p className="text-center mt-2">Wheel Condition</p>
                            </div>
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Hose Clamp Condition", "hoseClampCondition")} />
                                <p className="text-center mt-2">Hose Clamp Condition</p>
                            </div>
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Nozzle Condition", "nozzleCondition")} />
                                <p className="text-center mt-2">Nozzle Condition</p>
                            </div>
                            <div className="shadow-md p-2 bg-white rounded-sm">
                                <Pie data={getPieData("Unit Cleanliness", "unitCleanliness")} />
                                <p className="text-center mt-2">Unit Cleanliness</p>
                            </div>
                        </div>
                    </div>
                    ))}
                  ...
                  <h1 className="font-semibold text-xl text-center mb-2">Data Chart</h1><br />
                    <div className="overflow-y-auto overflow-x-auto max-h-96">
                        ...
                        <thead className="bg-gray-200 sticky top-0">
                            ...
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Damage Check</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Bolt Condition</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Valve Condition</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Wheel Condition</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Hose Clamp Condition</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Nozzle Condition</th>
                            <th className="border border-gray-300 px-4 py-2 text-left text-sm font-semibold whitespace-nowrap w-1/12">Unit Cleanliness</th>
                        ...
                        <tbody>
                            ...
                            <tr key={item._id} className="hover:bg-gray-100">
                                ...
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.damageCheck}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.boltTightening}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.valveCondition}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.wheelCondition}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.hoseClampCondition}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.nozzleCondition}</td>
                                <td className="border border-gray-300 px-4 py-2 text-sm whitespace-nowrap">{item.unitCleanliness}</td>
...
export default FireHydrantSystemDash1d;
