...
const PanelDash24d = () => {
  ...
  const toggleDailyDropdown = (e) => {
    e.preventDefault();
    navigate('/panel_24_d_dashboard');
  };

  const toggleMonthlyDropdown = (e) => {
    e.preventDefault();
    navigate('/panel_24_m_dashboard');
  };

  const toggleQuarterlyDropdown = (e) => {
    e.preventDefault();
    navigate('/panel_24_q_dashboard');
  };

  const toggleTimeBasedDropdown = (e) => {
    e.preventDefault();
    navigate('/panel_24_tb_dashboard');
  }
  ...
  useEffect(() => {
    ...
    axios
      .get("https://scheq.in/api/panel_24_d")
      .then((response) => {
  ...
  const exportToCSV = () => {
    ...
    a.setAttribute('download', 'panel_24_daily_checksheet_data.csv');
    a.click();
    ...
    <>
        <div className='flex m-2 fixed'>
            ...
            <div className='flex w-full text-center m-4 bg-gray-900 z-50 rounded-xl shadow-lg shadow-gray-700 ml-6 overflow-hidden'>
                <div className='w-full'>
                    <h1 className='text-2xl mt-2 font-extrabold text-gray-200'>Panel - 24 Dashboard VT1014532-F10</h1>
                </div>
            </div>
        </div>
        <br /><br /><br /><br />
        <div className='bg-gray-900 w-fit m-3 rounded-xl z-50 p-2 shadow-lg shadow-gray-700 text-white overflow-hidden fixed'>
            ...
            <>
                ...
                <h1 className="text-2xl text-center font-bold mb-4">Panel - 24 Daily Dashboard</h1>
